...
$upload_dir = '/damas/public/images/uploads/'; // path from base_url to upload base dir
$current_path = '../../../../../images/uploads/'; // relative path from filemanager folder to upload files folder
